        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            {['admin', 'ngo', 'volunteer'].includes(user.role) && (
                <div className="flex flex-wrap gap-2 mb-6">
                    <button onClick={() => setFilter('All')} className={`px-4 py-2 rounded-full text-sm font-medium ${filter === 'All' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
                        All
                    </button>
                    <button onClick={() => setFilter('Pending')} className={`px-4 py-2 rounded-full text-sm font-medium ${filter === 'Pending' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
                        Pending
                    </button>
                    <button onClick={() => setFilter('Approved')} className={`px-4 py-2 rounded-full text-sm font-medium ${filter === 'Approved' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
                        Approved
                    </button>
                    {user.role === 'volunteer' ? (
                        <>
                    ...
                    <button onClick={() => setFilter('Delivered')} className={`px-4 py-2 rounded-full text-sm font-medium ${filter === 'Delivered' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
                        Delivered
                    </button>
                </div>
            )}
